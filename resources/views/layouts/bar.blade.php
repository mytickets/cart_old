                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <a href="#" class="module module-cart right" data-toggle="panel-cart">
                            ...
                            <span id="cart_id" style="display: none;" data-id={{ $cart->id }}></span>
                            <span class="cart-value" id="cart-value"></span>
        ...
        <div id="panel-cart" class="">
            <div class="panel-cart-container">
                <div class="panel-cart-title">
                    <h5 class="title">Корзина #{{ $cart->id }}</h5>
                    <button class="close" data-toggle="panel-cart"><i class="ti ti-close"></i></button>
                </div>
                <div class="panel-cart-content" id="app">
                        ...
                        <tbody>
                            @foreach ($cart->line_items as $item)
                                <tr>
                                    {{-- /line_item_remove/{id} --}}
                                    <td class="title">
                                        <span class="name"><a href="#productModal" data-toggle="modal">{{ $item->product->name }}</a></span>
                                        <span class="caption text-muted">{{ $item->product->desc }}</span>
                                    </td>
                                    <td class="price">{{ $item->product->price_amount }} руб.</td>
                                    <td class="actions">
                                        {{-- <a href="#productModal" data-toggle="modal" class="action-icon"><i class="ti ti-pencil"></i></a> --}}
                                        {{-- <a href="#" class="action-icon remove_line_item" data-id={{ $item->id }}><i class="ti ti-close"></i></a> --}}
                                        <a href="#" class=" remove_line_item" data-id={{ $item->id }}>X</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
                    ...
                    <div class="cart-summary" >
                        {{-- <div class="row">
                            ...
                            <div class="col-5"><strong>{{ $cart->total() }}</strong></div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row text-lg">
                            ...
                            <div class="col-5"><strong id="cart-value2"></strong></div>
                        </div>
                    </div>
                </div>
            </div>
